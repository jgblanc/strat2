...
```{r}
tmp1 <- fread("../plots/error/rare_R2EO_HGDP1KG.txt") %>% select(-estimate)
...
# Final arrangement
pl <- grid.arrange( row_a, row_b, row_c, ncol = 1, heights = c(1, 1, 1.3))
ggsave("~/Desktop/ChrRatio_supp.png", pl, height = 10, width = 12)
```
